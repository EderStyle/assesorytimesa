<a href="#" name="quienessomos"></a>
  ...
  <div>
	...
	<div class="row">
		...
		<div class="col m9 s12">
				...
				<p style="text-align: justify">
					...
					sus empresas, organizaciones e instituciones en general, con herramientas tecnológicas
					actualizadas y funcionales, para que las decisiones tomadas repercutan en el valor que
					ellos entregan a sus clientes.
	...
	<div class="row">
		...
		<div class="col m3 s12">
			<img class="circle responsive-img hide-on-small-and-down" src="images/somos/vision.jpg">
		</div>
	</div>

	<div class="row">
		<div class="col m3 s12">
			<img class="circle responsive-img hide-on-small-and-down" src="http://www.moretto.com/media/162/w-400/h-400/meeting.17a0525d.jpg">
		</div>
		<div class="col m9 s12">
				...
				<p style="text-align: justify" >
					...
					Se consolida como una empresa de asesoría integral, cuando la estructura operativa de las empresas nos obligaban a incurrir en áreas especificas, como la imagen, las ventas, el mercado, y las permanentes necesidades de investigaciones para que los gerentes o directivos tengan decisiones con un riesgo muy bajo y previsto en un plan de contingencia que sustente el Efecto y el Impacto.
	...
	<div class="row">
		<div class="col m9 s12">
		    ...
		    <div class="col m3 s12">
			<img class="circle responsive-img hide-on-small-and-down" src="images/somos/proposito1.jpg">
		  </div>
	   </div>
